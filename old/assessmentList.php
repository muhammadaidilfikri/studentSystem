				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD Assessment Details</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<div align="right">
								<form action="addAssessment.php" method="post">
							 <button type="submit" value="submit" class="btn m-btn--pill btn-outline-primary active" >Add New Assessment </button>
								</form>
								<br>
							</div>
						<!-- tables starts here -->
						<div class="m-portlet">
                          ...
                          <tbody>
                            ...
                            <?
$sql_events = mysqli_query($connection, "select * from training where prog_id!='99' ") or die (mysql_error());
$z =1;
...
?>
                              ...
                              <td><? echo $prog_name ?></td>
                              <td><? echo $prog_date ?></td>
							  <td><? echo $venue ?></td>
							  <td>
							    
							   <a href="addAssessment.php?prog_id=<? echo $prog_id ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
								  <span>
