				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD BEQ Status</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<div class="m-portlet">
                          ...
                          <tbody>
                            ...
                            <?
								$sql_events = mysqli_query($connection, "select * from training,profile,ipta,tblSecurity,regprog,qbei where qbei.user_id=regprog.user_id and  regprog.user_id=profile.user_id and tblSecurity.id=regprog.ass_id and training.prog_id=regprog.prog_id and ipta.ipta_id=profile.ipta_id ") or die (mysql_error());
								$z =1;
								...
								while ($row = mysqli_fetch_array($sql_events)) {
									...
									$tar = $row["tar"];
									$ipta_a = $row["ipta_a"];
									$bei_stat = $row["bei_stat"];
									$bei_date = $row["timestamp"];
							  ...
							  <td>
							   ...
							   <a href="../beq/viewBEQ.php?user_id=<? echo $user_id ?>" target="_blank" class="btn btn-success m-btn btn-sm 	m-btn m-btn--icon">
								  <span>
