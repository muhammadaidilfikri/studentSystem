						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								<div class="m-section__content">
									...
									<form class="m-form m-form--fit m-form--label-align-right" action="checkVid.php" method="post">
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group">
											  ...
											  <select class="form-control m-input m-input--solid" name="user_id" id="user_id">
												...
												<input type="text" class="form-control m-input m-input--solid" name="vid_url" id="vid_url" aria-describedby="vid_url" placeholder="Paste the URL of that assessment video">
												<span class="m-form__help">Copy the Youtube Link</span>
											</div>
