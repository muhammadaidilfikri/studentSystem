...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			UniLEAD | DVC Fit List Phase III
		</title>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">
									Deputy Vice Chancellor Fit List
								(Phase III)</h3>
							</div>
							<div>
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=4 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'S%' and phase=3 ") or die (mysqli_error());
								$z =1;
								...
								while ($row = mysqli_fetch_array($sql_events)) {
									...
									<tr>
									  ...
									  <td align="center"><a href="resultDVC2.php?user_id=<? echo $user_id ?>"><i class="fa fa-print" /></td>
									</tr>
									<?
										$z++; }
									?>
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=4 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'D%' and phase=3 ") or die (mysqli_error());
								$z =1;
								...
								while ($row = mysqli_fetch_array($sql_events)) {
									...
									<tr>
									  ...
									  <td align="center"><? echo $z1 ?></td>
									  <td align="center"><? echo $JF02 ?></td>
									  <td align="center"><a href="resultDVC.php?user_id=<? echo $user_id ?>"><i class="fa fa-print" /></td>
									</tr>
									<?
										$z++; }
									?>
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=4 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'R%' and phase=3") or die (mysqli_error());
								$z =1;
