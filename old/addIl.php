						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Add New IL</h3>
									</div>
								</div>
							</div>
							...
							<div class="m-portlet__body">	
								<div class="m-section__content">
									...
									<form class="m-form m-form--fit m-form--label-align-right" action="checkIl.php" method="post">
										<div class="m-portlet__body">
											
											<div class="form-group m-form__group">
												<label for="Salutation">IL Name</label>
												<input type="text" class="form-control m-input m-input--solid" name="il_name" id="il_name" aria-describedby="il_name" placeholder="Put the IL here">
											</div>
											
											<div class="form-group m-form__group">
												<label for="Authentication">Authentication Level</label>
												<select class="form-control m-input m-input--solid" name="il_p" id="il_p">
