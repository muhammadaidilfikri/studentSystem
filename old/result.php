		...
		>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
						...
						<?
$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa, competency where competency.user_id=profile.user_id  and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and cfa.user_id='$u_id' limit 1") or die (mysql_error());
$z =1;
