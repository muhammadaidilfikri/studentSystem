				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD Assessment Video</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<!-- end section -->
							<div align="right">
							 ...
							 <button type="submit" value="submit" class="btn m-btn--pill btn-outline-primary active" >Add New Video URL </button>
								</form>
								<br>
							</div>
						...
						<div class="m-portlet">
                          ...
                          <tbody>
                            ...
                            <?
								$sql_events = mysqli_query($connection, "select * from training,profile,ipta,tblSecurity,regprog,vid where vid.user_id=profile.user_id and  regprog.user_id=profile.user_id and tblSecurity.id=regprog.ass_id and training.prog_id=regprog.prog_id and ipta.ipta_id=profile.ipta_id") or die (mysql_error());
								$z =1;
                              ...
                              <td><? echo $curr ?></td>
							  <td><? echo $tar ?></td>
							  <td><a href="<? echo $vid_url ?>" target="_blank">Watch it</a></td>
							  <td><? echo $vid_date ?></td>
						    </tr>
                            <?
	$z++;
