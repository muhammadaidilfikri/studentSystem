				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD IL Career Level</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<div align="right">
								<form action="addIl.php" method="post">
							 <button type="submit" value="submit" class="btn m-btn--pill btn-outline-primary active" >Add New IL List</button>
								</form>
								<br>
							</div>
							...
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">IL Career Level List</h3>
									</div>
								</div>
							</div>
                          ...
                          <tbody>
                            ...
                            <?
									...
									?>
																  ...
																  <td><? echo  $il_name?></td>
																  <td><a href="#" class="btn btn-brand m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill"><i ><? echo  $il_p?> </i></a></td>
																</tr>
																<?
