						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Add New Salutation</h3>
									</div>
								</div>
							</div>
							...
							<div class="m-portlet__body">	
								<div class="m-section__content">
									...
									<form class="m-form m-form--fit m-form--label-align-right" action="checkSal.php" method="post">
										<div class="m-portlet__body">
											
											<div class="form-group m-form__group">
												<label for="Salutation">Salutation</label>
												<input type="text" class="form-control m-input m-input--solid" name="sal" id="sal" aria-describedby="sal" placeholder="Put the salutation here">
											</div>
