				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Add Academic List</h3>
							</div>
							<div>
						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Add New Academic List</h3>
									</div>
								</div>
							</div>
							...
							<div class="m-portlet__body">	
								<div class="m-section__content">
									...
									<form class="m-form m-form--fit m-form--label-align-right" action="checkAcadL.php" method="post">
										<div class="m-portlet__body">
											
											<div class="form-group m-form__group">
												<label for="Salutation">Academic Name</label>
												<input type="text" class="form-control m-input m-input--solid" name="acl_name" id="acl_name" aria-describedby="acl_name" placeholder="Put the Academic list here">
											</div>
