						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=5 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'S%' and phase=3 ") or die (mysqli_error());
								$z =1;
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=5 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'D%' and phase=3 ") or die (mysqli_error());
								$z =1;
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">	
								...
								<table class="table">
		 						...
		 						<?	  
								$sql_events = mysqli_query($connection, "select * from profile, ipta, cfa where  ncpl2=5 and cfa.user_id=profile.user_id and  profile.ipta_id=ipta.ipta_id and JF02 like 'R%' and phase=3") or die (mysqli_error());
								$z =1;
