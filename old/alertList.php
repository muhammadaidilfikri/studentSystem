				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD Position Alert List</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<!-- end section -->
						 ...
						 <div align="right">
								<form action="addUA.php" method="post">
							 <button type="submit" value="submit" class="btn m-btn--pill btn-outline-primary active" >Add New University </button>
								</form>
								<br>
							</div>
						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">University / Instititute / Department List</h3>
									</div>
								</div>
							</div>
                          ...
                          <tbody>
                            ...
                            <?
									$sql_events = mysqli_query($connection, " select * from alert, ipta, position where alert.ipta_id=ipta.ipta_id and position.post_id=alert.post_id order by ipta.ipta_id asc") or die (mysql_error());
									$z =1;
									...
									?>
																  ...
																  <td><? echo strtoupper($name) ?> </td>
																  <td><? echo $ipta ?> </td>
																  <td><? echo $position ?> </td>
																  <td><? echo $date_start ?> </td>
																  <td><? echo $date_end ?> </td>
																  <td><? echo $term ?> </td>
																</tr>
																<?
