				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">UniLEAD Academic Career Level</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<!-- end section -->
						    <div align="right">
								<form action="addAcadL.php" method="post">
							 <button type="submit" value="submit" class="btn m-btn--pill btn-outline-primary active" >Add New Academic Level</button>
								</form>
								<br>
							</div>
						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Academic Career Level List</h3>
									</div>
								</div>
							</div>
                          ...
                          <tbody>
                            ...
                            <?
									$sql_events = mysqli_query($connection, "select * from acl") or die (mysql_error());
									$z =1;
