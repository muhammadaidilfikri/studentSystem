				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Add University</h3>
							</div>
							<div>
						...
						<div class="m-portlet">
							<div class="m-portlet__head">
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">Add New University</h3>
									</div>
								</div>
							</div>
							...
							<div class="m-portlet__body">	
								<div class="m-section__content">
									...
									<form class="m-form m-form--fit m-form--label-align-right" action="checkUA.php" method="post">
										<div class="m-portlet__body">
											
											<div class="form-group m-form__group">
												<label for="Username">University</label>
												<input type="text" class="form-control m-input m-input--solid" name="ipta" id="ipta" aria-describedby="ipta" placeholder="University Names">
											</div>
											
											<div class="form-group m-form__group">
												<label for="Name">Acronym</label>
												<input type="text" class="form-control m-input m-input--solid" name="ipta_a" id="ipta_a" aria-describedby="ipta_a" placeholder="UA Acronym">
