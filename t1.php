			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
									...
									<!-- put your content here -->
										...
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group">
												...
												<input type="text" class="form-control m-input m-input--solid" name="fPost" id="fPosition" aria-describedby="fPost" placeholder="<? echo $fPost ?>" readonly>
											</div>
											...
											<div class="form-group m-form__group">
												<label for="Position">Pekerjaan</label>
												<input type="text" class="form-control m-input m-input--solid" name="mPost" id="mPost" aria-describedby="mPost" placeholder="<? echo $mPost ?>" readonly>
											</div>
					...
					<form action="t2.php" method="post">
						...
						<input type="hidden" id="fPost" name="fPost" value="<? echo $fPost ?>">
						...
						<input type="hidden" id="mPost" name="mPost" value="<? echo $mPost ?>">
						...
						<input type="hidden" id="noPhone" name="noPhone" value="<? echo $noPhone ?>">
						<input type="hidden" id="email" name="email" value="<? echo $email ?>">
						<input type="hidden" id="address" name="address" value="<? echo $address ?>">
						<input type="hidden" id="address2" name="address2" value="<? echo $address2 ?>">
						<input type="hidden" id="address2" name="address2" value="<? echo $address2 ?>">
						<input type="hidden" id="postcode" name="postcode" value="<? echo $postcode ?>">
						<input type="hidden" id="city" name="city" value="<? echo $city ?>">
						<input type="hidden" id="district" name="district" value="<? echo $district ?>">
