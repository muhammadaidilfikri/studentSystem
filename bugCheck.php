...
$bugMenu = $_POST['bugMenu'];
$bugdetail = $_POST['bugdetail'];
$ssid = $_SESSION['username'];
$timestamp = time();


$sql2 = "insert into bugs (bugMenu,bugdetail,stdNo,timestamp) values ('$bugMenu','$bugdetail','$ssid','$timestamp')";
$mysqli->query($sql2);
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Bug Reporting Form</h3>
							</div>
							<div>
					...
					<div class="m-content">
						...
						<div class="m-portlet m--bg-success m-portlet--bordered-semi m-portlet--skin-dark m-portlet--full-height ">
							...
							<div class="m-portlet__body">
								<div class="m-widget7 m-widget7--skin-dark">
									<div >
									<h4>We have received and review your feedback. Thank you. </h4>
									</div>
						...
						<div class="m-widget7__button" align="center">
							<a class="m-btn m-btn--pill btn btn-accent" href="main.php" role="button">Home</a>
						</div>
