            ...
            <div class="m-portlet__body">
              ...
              <!--begin: Datatable -->
							...
							if (mysqli_num_rows($result)==0) {
								?>
                <p>Pendaftaran kelab hanya akan dibuka pada 27 Ogos 2021. Sila Layari Telegram Rasmi Pusat Asasi bagi maklumat terkini.</b></p>
							<?
						}
						else {
                ...
                $club_ws = $row["club_ws"];
								?>
								<p>Anda telah mendaftar Kelab / Persatuan <b><? echo $club_name?></b>. Sila klik <a href="<? echo $club_ws ?>" target="_blank"> pautan Whatsapp ini</a> bagi memasuki kelab yang telah didaftar. </p>
								<?
